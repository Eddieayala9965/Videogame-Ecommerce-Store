...
def get_game_details(game_slug: str) -> Optional[Dict[str, Any]]:
   """Fetch game details from RAWG API using the game slug."""
   
   url = f"{BASE_URL}/games/{game_slug}?key={RAWG_API_KEY}"
